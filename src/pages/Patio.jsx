...
export default function Patio() {
  ...
  // ── Dev Mode & Time Simulation ──
  const [devForcePeak, setDevForcePeak] = useState(null); // null, true, false

  // Detect current time & peak status
  const timeInfo = useMemo(() => {
    ...
    // Turno: Manhã (06:00 as 12:59), Tarde (13:00 as 18:59)
    const currentShift = hours < 13 ? 'manha' : 'tarde';

    // Horário de Pico: 06:30 AM (390m) às 07:15 AM (435m)
  ...
  // Auto-fill location in Peak Mode
  useEffect(() => {
  ...
  // Search Results with shift & eletiva tags
  ...
  // Observations with text from today
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.headerRow}>
        ...
        {/* Peak / Shift Indicator & Dev Toggle */}
        ...
        <div className={styles.searchWrapper}>
          ...
          {searchQuery.length >= 2 && results.length === 0 && (
            <ul className={styles.resultsList}>
              <li style={{ padding: '14px', textAlign: 'center', color: 'var(--color-text-secondary)' }}>
                Nenhum aluno encontrado no turno
              </li>
            </ul>
          )}
        </div>
      ...
      {selectedStudent && !occurrenceLogged && (
        <>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Title3>Ocorrência Pátio</Title3>
          </div>
            ...
            <div className={styles.studentInfo}>
              ...
              <div className={styles.historyBadgeRow}>
                {historyBadges.map((b, idx) => (
                  <span
                    key={idx}
                    className={styles.historyIconBadge}
                ...
                {/* Popover for Today's Observations */}
                  ...
                  <Popover trapFocus>
                    ...
                    <PopoverSurface tabIndex={-1}>
                      <div style={{ padding: '8px', maxWidth: '280px' }}>
                        <Text weight="semibold" block style={{ marginBottom: '6px' }}>
                          Histórico de Observações Hoje
                        </Text>
          ...
          <div>
            ...
            <div className={styles.ctaGrid}>
              <button
                ...
                onClick={() => handleMotiveClick('FALTA DE UNIFORME')}
              >
                👕 FALTA DE UNIFORME
              </button>
              ...
              <button
                ...
                onClick={() => handleMotiveClick('Adorno Inadequado')}
              >
                💍 Adorno Inadequado
              </button>
              ...
              <button
                ...
                onClick={() => handleMotiveClick('Falta de calçado (Crokqs)')}
              >
                🩴 Falta de Calçado
              </button>
              ...
              {!timeInfo.isPeakMode && (
                <>
                  <button
                    ...
                    onClick={() => handleMotiveClick('Uso de Celular')}
                  >
                    📱 Uso de Celular
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => handleMotiveClick('Conversa em Excesso')}
                  >
                    🗣️ Conversa Excesso
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => handleMotiveClick('Corrida / Acidente')}
                  >
                    🏃 Corrida / Acidente
                  </button>
                </>
          ...
          {/* ─── 3. Observações (Ocultas no Horário de Pico) ─── */}
      ...
      {occurrenceLogged && (
        <Card className={styles.successCard} appearance="filled-alternative">
          ...
          <Text block size={200} style={{ marginTop: '4px', color: 'var(--color-text-secondary)' }}>
            Local: {occurrenceLogged.location} | {new Date(occurrenceLogged.date).toLocaleTimeString('pt-BR')}
          </Text>
